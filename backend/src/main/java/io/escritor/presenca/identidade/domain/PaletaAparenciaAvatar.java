 ...
 * {@code frontend/src/features/escritorio/avatar/paletaAvatar.ts} (mesmos hex) - qualquer mudança
 * aqui precisa da mudança irmã lá, senão o editor mostra uma cor que o servidor rejeita. Não é um
 * color picker livre de propósito (mais fácil de manter tudo combinando visualmente, igual à
 * grade de swatches dos prints de referência do Gather que motivaram esta funcionalidade).
 */
