...
/** Os 4 campos de estilo são enums tipados de propósito - o Jackson já rejeita um valor fora do
 * enum com 400 antes mesmo de chegar no controller, sem precisar de validação manual pra isso.
 * As 3 cores continuam `String` (hex) - validadas contra a paleta curada em
 * {@code PaletaAparenciaAvatar#validar}, não por Bean Validation aqui (a paleta pode mudar sem
 * mexer neste DTO). */
