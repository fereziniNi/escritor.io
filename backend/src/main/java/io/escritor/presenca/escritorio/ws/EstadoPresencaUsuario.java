 ...
 * troca a instância inteira no mapa concorrente de {@link PresencaWebSocketHandler}, sem mutação
 * de campo. `aparencia` é carregada uma vez na conexão (ver {@link PresencaHandshakeInterceptor})
 * e atualizada ao vivo por {@link PresencaWebSocketHandler#atualizarAparencia} quando a pessoa
 * personaliza o avatar enquanto já está no mapa - pedido do usuário: "a opção para todos detalhar
 * da melhor maneira possível o avatar".
 */
