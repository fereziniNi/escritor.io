...
/**
 * Editor de personagem (pedido do usuário: "o personagem fosse mais detalhado... a opção para
 * todos detalhar da melhor maneira possível o avatar", com prints reais do editor do Gather como
 * referência de composição - abas por categoria, grade de swatches de cor, prévia ao vivo,
 * "Finalizar" salvando no fim). Aberto pela bolha do próprio avatar em `MenuUsuario` (mesmo padrão
 * de painel flutuante que todo o resto do dock já usa - `EscritorioPage`/`BarraFerramentas`).
 *
